...
class BenchmarkComponent extends Component<any> {
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView>
          <View style={styles.content}>
            ...
            <Text>Press clear before rendering new</Text>
...
export const SimpleBenchmark = ({ navigation } : IScreenProps) => {
  const Content = withUIAndCodeTab(navigation, 'Please view code on editor or github',
    <BenchmarkComponent />
  );
  return <Content />
};